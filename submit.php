...
if(!empty($_POST['stripeToken'])){
    ...
    //set api key
   /* $stripe = array(
      "secret_key"      => "sk_test_shILnbtPx9OXCWlS3oqDc33G",
      "publishable_key" => "pk_test_wqnIxV7FD25h50b5XTlsBYzg"
    );*/
	...
	$stripe = array(
      "secret_key"      => "sk_test_WljN5smvgc5fnfgBRP6dmqyo00I6WlLYHx",
      "publishable_key" => "pk_test_Zk0ZG0Ro9hv94ru8y1wu8hdc008QFJzpn8" );
